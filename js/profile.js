...
function edit(event) {
    openModal();
    var titulo = event.target.parentNode.parentNode.children[0].children[0].children[0].innerText;
    var description = event.target.parentNode.parentNode.children[0].children[0].children[1].innerHTML;
    var id = event.target.parentNode.parentNode.id;
    var category = event.target.parentNode.parentNode.children[0].children[0].children[2].innerText;
    ...
    // document.getElementById("newPostInput").name = "";
